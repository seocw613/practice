...
function changePhone3(){
    ...
    if(phone3.length === 4){
      ...
      document.getElementById("sendMessage").setAttribute("style","background-color:#391a1a;")
...
function initButton(){
  ...
  document.getElementById("sendMessage").setAttribute("style","background-color:#391a1a;")
  document.getElementById("completion").setAttribute("style","background-color:#391a1a;")
}
...
function checkCompletion(){
  ...
  document.getElementById("signUpButton").setAttribute("style","background-color:#391a1a;")
}
